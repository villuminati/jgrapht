/*
 * (C) Copyright 2005-2018, by  Rishi Mishra and Contributors.
 *
...
/**
 * Create a random sparse graph based on the $G(n, p)$ Erdős–Rényi model. See the Wikipedia article for
 ...
 * the generator is $O(n+m)$ where $n$ is the number of vertices and m is the number of edges.
 *
 * <p>
 * For the $G(n, M)$ model please see {To be added GnmRandomSparseGraphGenerator}.
 *
 * @author Rishi Mishra
 *
 ...
 *
 * @see {To be added GnmRandomSparseGraphGenerator}
 */
public class GnpRandomSparseGraphGenerator<V, E>
    implements
    GraphGenerator<V, E, V>
{
     ...
     */
    public GnpRandomSparseGraphGenerator(int n, double p)
    {
     ...
     */
    public GnpRandomSparseGraphGenerator(int n, double p, long seed)
    {
     ...
     */
    public GnpRandomSparseGraphGenerator(int n, double p, long seed, boolean createLoops)
    {
     ...
     * @param createLoops whether the generated graph may create loops
     */
    public GnpRandomSparseGraphGenerator(int n, double p, Random rng, boolean createLoops)
    {
        if (n < 0) {
    ...
    public void generateGraph(Graph<V, E> target, Map<String, V> resultMap)
    {
        ...
        while (v<n){
            ...
            w = w + 1 + Math.floor(Math.log(1-rng.nextDouble())/Math.log(1-p));
